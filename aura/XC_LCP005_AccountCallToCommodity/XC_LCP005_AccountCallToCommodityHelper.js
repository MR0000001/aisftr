({
    doInit: function (component, event, helper) {
        ...
        */
        ...
        console.log('lcp005 ' + JSON.stringify(responseResult));
        ...
        if (sections !== null) {
            ...
            if (billProfSection && billProfSection.objectsRecordFields) {
                ...
                helper.createSectionComponent(component, $A.get("$Label.c.XC_CL_BillingProfile"), billProfDataName, 'v.billProfSectionBody');
            }
            //Sezione LegalEntity
            ...
            if (leSection && leSection.objectsRecordFields) {
                ...
                helper.createSectionComponent(component, 'Consents Data', legalEntityDataName, 'v.legalEntity');
            }
            //Sezione Address
            ...
            if(invoicesSection && invoicesSection.objectsRecordFields){
                ...
                helper.createSectionComponent(component, $A.get("$Label.c.XC_CL_CommodityInvoices"), invoicesDataName, 'v.invoicesSectionBody');
            }
            ...
            if (casesSection && casesSection.objectsRecordFields) {
                ...
                helper.createSectionComponent(component, $A.get("$Label.c.XC_CL_CommodityCases"), casesDataName, 'v.casesSectionBody');
            }
            var contractSection = sections['Contract'];
            if (contractSection && contractSection.objectsRecordFields) {
                for (var index in contractSection.objectsRecordFields) {
                    helper.createSectionFields(contractSection.objectsRecordFields[index], component, contractSectionDataName);
                }
                helper.createSectionComponent(component, $A.get("$Label.c.XC_CL_CommodityContracts"), casesDataName, 'v.ContractSectionBody');
            }
            var contractSection = sections['Contract'];
            if (contractSection && contractSection.objectsRecordFields) {
                for (var index in contractSection.objectsRecordFields) {
                ...
                helper.createSectionComponent(component, 'Contract', casesDataName, 'v.ContractSectionBody');
            }
        }
