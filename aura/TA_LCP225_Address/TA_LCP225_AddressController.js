({
    ...
    handleOnChangeEvent : function(component, event, helper) {
        console.log('TA_LCP220_LeadConversion >> Helper >> handleOnChange >> Start');
        helper.onChangeEvent(component, event, helper);
        console.log('TA_LCP220_LeadConversion >> Helper >> handleOnChange >> End');
    },

    //OK
    /*typingAddress: function (cmp, evt, hlp) {
        hlp.typingAddress(cmp, hlp)
        hlp.sendChanges(cmp, hlp)
    },

    //OK
    typingCity: function (cmp, evt, hlp) {
        hlp.typingCity(cmp, hlp)
        hlp.sendChanges(cmp, hlp)
    },

    //OK
    typingZip: function (cmp, evt, hlp) {
        hlp.typingZip(cmp, hlp)
        hlp.sendChanges(cmp, hlp)
    },*/
