 ...
 * 1.0   19-12-2020   Amit Singh   Initial Version
 * 1.1   03-05-2022   Marco Lazzaroni (mlazzaroni@pic-informatica.it)
 **/
import { LightningElement, api, track, wire } from 'lwc';
import search from '@salesforce/apex/TAMLookupController.search';
import getRecentlyCreatedRecord from '@salesforce/apex/TAMLookupController.getRecentlyCreatedRecord';

const DELAY = 10;

import { NavigationMixin } from 'lightning/navigation';

export default class TamLookupComponent extends NavigationMixin(LightningElement) {
